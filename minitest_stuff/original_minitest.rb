# Orinial minitest code
# found by watching this talk on minitest:
# https://www.youtube.com/watch?v=ojd1G4gOMdk
  ...
  class Unit
      ...
      ObjectSpace.each_object(Class) do |klass|
        ...
        klass.public_instance_methods(true).each do |meth|
          ...
          begin
            ...
            print "\n", (e.is_a?(Test::Assertion) ? 'Failure: ' : 'Error: ')
            puts "#{klass}.#{meth}: #{e}"
            puts e.backtrace
          end
        end
    ...
    class TestCase
      ...
      def assert_kind_of(cls, obj, msg = nil)
        assert obj.is_a?(cls), msg || "Expected #{obj.inspect} to be a kind of #{cls}"
      end
